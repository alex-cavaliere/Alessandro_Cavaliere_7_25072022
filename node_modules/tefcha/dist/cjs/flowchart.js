...
exports.Flowchart = exports.createFlowchart = void 0;
...
var Flowchart = /** @class */ (function () {
    function Flowchart(_a) {
        ...
        this.step = function (distance, isArrow) {
            ...
            _this.shapes.add(shape_1.Path.vline({ x: 0, y: _this.y, step: distance, isArrow: isArrow }));
            _this.move(distance);
        };
        ...
        this.wrapText = function (_a) {
            ...
            return new shape_1.Group({ x: x, y: y, children: [textShape, wrapShape] });
        };
        this.text = function (_a) {
            var x = _a.x, y = _a.y, w = _a.w, h = _a.h, text = _a.text, isLabel = _a.isLabel;
            return new shape_1.Text({
                content: text,
                x: x, y: y,
                w: w, h: h,
                isLabel: isLabel,
        ...
        this.textWithAutoSize = function (_a) {
            ...
            return shape_1.Text.byMeas({ x: x, y: y, text: text, attrs: _this.config.text.attrs, meas: _this.measureText, isLabel: isLabel });
        };
        ...
        this.branch = function () {
            ...
            return new Flowchart({
                shapes: new shape_1.Group({ x: _this.x, y: _this.y, children: [] }),
        ...
        this.withLoop = function (type, func) {
            ...
            var newAllocW = new range_allocator_1.RangeAllocator(range_allocator_1.createRangeList());
            // NOTE: 
        ...
        this.h = function (y, text) {
            if (text === void 0) { text = ''; }
            _this.shapes.add(shape_1.Path.hline({
                x: 0,
                y: y,
                step: 100,
            }));
            if (text !== '') {
                _this.shapes.add(new shape_1.Text({
                    content: text,
                    x: 0,
                    y: y,
                    w: 0, h: 0,
...
var createFlowchart = function (_a) {
    ...
    var flowchart = new Flowchart({
        shapes: new shape_1.Group({ x: 0, y: 0, children: [] }),
        measureText: measureText,
        config: config,
        loop: new LoopStackInfo(),
        AllocW: new range_allocator_1.RangeAllocator(range_allocator_1.createRangeList()),
        AllocE: new range_allocator_1.RangeAllocator(range_allocator_1.createRangeList()),
    ...
    while (childIdx < childNum && flowchart.alive) {
        ...
        switch (child.type) {
            ...
            case 'continue': {
                ...
                var breaks = loop.breaks, continues = loop.continues;
                (child.type === 'break' ? breaks : continues).push(new shape_1.Point({ x: 0, y: flowchart.y }));
...
var createIfFlowchart = function (nodes, flowchart, jump) {
    ...
    if (!no.jump && !yes.jump) {
        ...
        ifFlowchart.shapes.add(shape_1.Path.hline({
...
var createWhileFlowchart = function (node, flowchart) {
    ...
    if (blockFlowchart.alive) {
        ...
        AllocW.merge(pos, hlineMargin);
        stepAbs(pos + hlineMargin);
        loopBackPoints.push(new shape_1.Point({ x: 0, y: blockFlowchart.y }));
    }
    exitPoints.push(new shape_1.Point(__assign({}, condPos.E)));
...
var createTryExceptFlowchart = function (tryNode, exceptNodes, flowchart) {
    ...
    blockFlowchart.shapes.add(new shape_1.Frame({
        x: rectX,
        y: frameTopY,
    ...
    // draw "exceptHline".
    tryFlowchart.shapes.add(shape_1.Path.hline({
...
var createSwitchCaseFlowchart = function (switchNode, caseNodes, flowchart) {
    ...
    // draw "caseHline"
    blockFlowchart.shapes.add(shape_1.Path.hline({
        x: 0,
        y: caseHlineY,
